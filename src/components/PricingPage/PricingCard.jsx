    ...
    <div className='container mx-auto mt-[50px]'>
      <div className="flex flex-wrap items-center justify-center gap-6">
            ...
            <div className="w-72 bg-white text-center text-gray-800/80 border border-gray-500/30 p-6 pb-16 rounded-lg">
                ...
                <ul className="list-none h-[100%] text-gray-500 text-sm mt-6 space-y-1">
            ...
            <div className="w-72 bg-white relative text-center text-gray-800/80 border-2 border-indigo-500 p-6 pb-14 rounded-lg">

                <p className="absolute px-3 text-sm text-white -top-3.5 left-3.5 py-1 bg-indigo-500 rounded-full">Most Popular</p>
                ...
                <button type="button" className="bg-indigo-500 text-sm w-full py-2 rounded text-white font-medium mt-7 hover:bg-gray-200 transition-all">
                    Get Started
                </button>
            </div>
